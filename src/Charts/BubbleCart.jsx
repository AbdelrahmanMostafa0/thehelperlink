        ...
        <table className="min-w-full table-auto border-collapse border border-gray-300 shadow-md">
          <thead>
            <tr className="bg-green-500 text-white">
              <th className="border border-gray-300 whitespace-nowrap px-4 py-3 text-left text-sm sm:text-base text-center">
                Country
              </th>
              <th className="border border-gray-300 whitespace-nowrap px-4 py-3 text-left text-sm sm:text-base text-center">
                Visitors
          ...
          <tbody>
            {visitorsData.map((data, index) => (
              <tr key={index} className="text-gray-800 hover:bg-green-100 transition duration-300">
                <td className="border border-gray-300 px-4 py-2 text-sm sm:text-base text-center">
                  {data.country}
                </td>
                <td className="border border-gray-300 px-4 py-2 text-sm sm:text-base text-center">
                  {data.visitors}
                ...
                <td className="border border-gray-300 px-4 py-2 text-sm sm:text-base">
                  <div className="w-full bg-gray-200 rounded-full h-6 overflow-hidden">
                    <div
                      className="h-full text-center text-white text-sm font-bold transition-all duration-500"
                      style={{
